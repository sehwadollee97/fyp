...
class Sophia:
	...
	# It will stop when it reach the position or have high load
		...
		if calibration == False:
			...
			if position < min:
				position = min
				print("Lower than the min!You are moving out of limit setting position to", min)
			elif position > max:
				position = max
				print("Greater than max! You are moving out of limit setting position to", max)
