...
# detected corners (twodpoints)
    ...
    def read_csvfile(self):
        ...
        for i in self.filenames:
            ...
            self.data=pd.read_csv(i, names=['x'], delim_whitespace=True)
...
if __name__=='__main__':
    ...
    pan0, tilt0=camat.obtain_PT('*b_corners_updown636_left_tilt471.csv')
    x0, y0=camat.read_csvfile()

    pan1, tilt1=camat.obtain_PT('*b_corners_updown659_left_tilt471.csv')
    x1, y1=camat.read_csvfile()

    pan2, tilt2=camat.obtain_PT('*b_corners_updown684_left_tilt471.csv')
    x2,y2=camat.read_csvfile()
    pan3, tilt3=camat.obtain_PT('*b_corners_updown709_left_tilt471.csv')
